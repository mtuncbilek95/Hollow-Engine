...
namespace Hollow
{
		...
		void* pUserData)
	{
		...
		case VK_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT:
			CORE_LOG(HE_VERBOSE, "VulkanValidation", "%s", pCallbackData->pMessage);
			break;
		case VK_DEBUG_UTILS_MESSAGE_SEVERITY_INFO_BIT_EXT:
			CORE_LOG(HE_INFO, "VulkanValidation", "%s", pCallbackData->pMessage);
			break;
		case VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT:
			CORE_LOG(HE_WARNING,"VulkanValidation",  "%s", pCallbackData->pMessage);
			break;
		case VK_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_BIT_EXT:
			CORE_LOG(HE_ERROR, "VulkanValidation", "%s", pCallbackData->pMessage);
			break;
		default:
			break;
		}
